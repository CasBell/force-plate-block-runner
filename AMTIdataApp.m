% THIS IS A PRESERVED VERSION OF AMTIdataApp.m - COPY ALL THIS CODE INTO
% AMTIdataApp.m IF ALL ELSE FAILS AND EVERYTHING GOES HAYWIRE
...
function varargout = AMTIdataApp(varargin)
